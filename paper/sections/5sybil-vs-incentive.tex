...
We already address that, our sheme completely discourage a rational pool operator who wants get mining rewards.
However, there remains a concern that, we need to make a trade-off between Sybil resistance and incentivising miners to join mining.
Such a problem is known as Quadratic Voting~\cite{lalley2018quadratic}, and has been discussed in a post.

We explain the problem as follows.
...
harder to find solution -> unstable payouts for low investment, discourage miners 
