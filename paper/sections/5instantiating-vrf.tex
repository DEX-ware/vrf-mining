...
It should prevent adversaries from learning any knowledge of the input from its hash.
% deterministic
In addition, the $H_{1}(\cdot)$ function used in VRF should be deterministic, otherwise the hash will be unreproducible.

A standardisation document~\cite{scott2019hashing} specifies several hash-to-curve functions~\cite{icart2009hash, ulas2007rational, brier2010efficient, bernstein2013elligator} that fit into different elliptic curves and satisfy our requirements.
