...
For example, among prominent elliptic curves, Edwards25519~\cite{bernstein2012high} (birationally equivalent to the Curve25519~\cite{bernstein2006curve25519}) can be a promising choice.
