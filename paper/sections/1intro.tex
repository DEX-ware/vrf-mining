...
We give our construction of VRF-based mining in Section~\ref{sec:construction},
analyse its non-outsourceability in Section~\ref{sec:non_outsourceability},
and then explore the options on implementation in Section~\ref{sec:instantiation}.
