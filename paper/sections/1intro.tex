...
\begin{description}
    ...
    \item [Profitability] We discuss the issue of partial outsourcing in VRF-based mining. Partial outsourcing is that, a pool operator outsources computation that does not need the secret key to miners. We show that partial outsourcing is unprofitable, and we also discuss how to instantiate VRFs to make it even more costly.
\end{description}
