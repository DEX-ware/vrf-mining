...
\RH{We don't need to talk about PoS here. Let's do something like this: 1. delete PoS here, 2. add a Discussion section which discusses how to use VRF mining to discourage pooled staking.}
...
\RH{Merge the following two paragraphs to a single one. 
Here we aim at showing why there are mining pools.
The story should then be:
1. mining reward is fluctuating, in particular for small miners
2. some guys provide mining pools which let miners to join and reward in a fine-grained way}
...
% How mining pool works briefly (we will describe details later in Section2)
