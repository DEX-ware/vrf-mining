...
\TODO{flaws}
Moreover, our protocol in fact construct a stronger version of their \textit{Strongly nonoutsourceable puzzles} if integrating zero-knowledge transformation like in their protocol, because a pool participant can not only but also if the pool manager outsources the task and leakage
