...
\RH{intro of this section. e.g.,
While the mining power is decentralised, several problems may occur...
In this section, we discuss possible problems of having no mining pool...}


\subsection{High reward variance}

\RH{1. Discuss why high reward variance
2. Discuss possible solutions, including 1) multi-tier reward in Andrew Miller's paper, 2) StrongChain, and 3) Section4.2 of https://arxiv.org/pdf/1810.08092.pdf
}

\subsection{High orphan rate}

\RH{1. Discuss why high orphan rate
2. Discuss solutions, including 1) GHOST and uncle blocks, 2) speed up block propagation by block relays e.g., https://arxiv.org/abs/1905.10518, bloxroute, https://github.com/bitcoin/bips/blob/master/bip-0152.mediawiki}



RH{The original discussion on sybil resistance and incentive can be deleted, because it's about decentralisation, which is the topic after eliminating mining pools. A better way is to initiate another research proposing ways of balancing sybil resistance and incentive of small miners in order to achieve better decentralisation and contradict this paper https://arxiv.org/abs/1905.05158}
