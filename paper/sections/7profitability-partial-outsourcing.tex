...
To outsource $H_1(\cdot)$, the pool operator should receive all $H_1(\cdot)$ hashes computed by the miner.
To outsource $H_2(\cdot)$, the pool operator should send all $\gamma$s to the miner.
